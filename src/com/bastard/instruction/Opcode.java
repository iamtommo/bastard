...
//	DADD(0x63, StackInstruction.class),
...
//	DDIV(0x6F, BasicInstruction.class),
...
//	DMUL(0x6B, BasicInstruction.class),
//	DNEG(0x77, BasicInstruction.class),
...
//	DSUB(0x67, BasicInstruction.class),
...
//	FADD(0x62, BasicInstruction.class),
...
//	FDIV(0x6E, BasicInstruction.class),
...
//	FMUL(0x6A, BasicInstruction.class),
//	FNEG(0x76, BasicInstruction.class),
...
//	FSUB(0x66, BasicInstruction.class),
...
//	IAND(0x7E, BasicInstruction.class),
...
//	IMPDEP2(0xFF, BasicInstruction.class),
	...
	INEG(0x74, BasicInstruction.class),
...
//	ISHR(0x7A, BasicInstruction.class),
	...
	ISUB(0x64, BasicInstruction.class),
//	IUSHR(0x7C, BasicInstruction.class),
//	IXOR(0x82, BasicInstruction.class),
...
//	LADD(0x61, BasicInstruction.class),
//	LALOAD(0x2F, BasicInstruction.class),
//	LAND(0x7F, BasicInstruction.class),
//	LASTORE(0x50, BasicInstruction.class),
	...
	LMUL(0x69, BasicInstruction.class),
//	LNEG(0x75, BasicInstruction.class),
...
//	LSHL(0x79, BasicInstruction.class),
	LSHR(0x7B, BasicInstruction.class),
	...
	LSUB(0x65, BasicInstruction.class),
	LUSHR(0x7D,BasicInstruction.class),
